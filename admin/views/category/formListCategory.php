                                    ...
                                    <tbody>
                                        <?php foreach ($listCategory as $key => $Category) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="?act=form-edit-category&danh_muc_id=<?= $Category['danh_muc_id'] ?>" class="btn btn-warning btn-sm">Sửa</a>
                                                    <a href="?act=delete-category&danh_muc_id=<?= $Category['danh_muc_id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có chắc chắn muốn xóa danh mục này không?');">Xóa</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
