...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const orders = [
            {id: "DH001", customer: "Nguyễn Văn A", product: "Sản phẩm 1", total: "1,200,000đ", status: "Đã giao", date: "2024-03-20"},
            {id: "DH002", customer: "Trần Thị B", product: "Sản phẩm 2", total: "2,300,000đ", status: "Đang giao", date: "2024-03-19"},
            {id: "DH003", customer: "Lê Văn C", product: "Sản phẩm 3", total: "3,400,000đ", status: "Chờ xử lý", date: "2024-03-18"},
        ];
