        ...
        <div class="product-summary">
            ...
            <?php foreach ($_SESSION['checkout_data']['cart_items'] as $item): ?>
                <div class="product-info d-flex gap-3 mb-3">
                    ...
                    <div>
                        ...
                        <p>Giá: <?= number_format($item['gia'], 0, ',', '.') ?>₫</p>
                        <p>RAM: <?= $item['dung_luong'] ?></p>
                    </div>
                </div>
            <?php endforeach; ?>
            ...
            <div class="total-section">
                <div class="d-flex justify-content-between mb-2">
                    <span>Tạm tính:</span>
                    <span><?= number_format($_SESSION['checkout_data']['total'], 0, ',', '.') ?>₫</span>
                </div>
                <div class="d-flex justify-content-between mb-2">
                ...
                <div class="d-flex justify-content-between fw-bold">
                    <span>Tổng cộng:</span>
                    <span><?= number_format($_SESSION['checkout_data']['total'] + 30000, 0, ',', '.') ?>₫</span>
                </div>
            </div>
        </div>
    </div>
